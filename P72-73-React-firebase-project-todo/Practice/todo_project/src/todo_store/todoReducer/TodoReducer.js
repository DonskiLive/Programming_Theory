...
export default todoReducer.reducer; // here global data for app store
export const { addTodo, changeTodoStatus, removeTodo, setTodo, clearTodo } = todoReducer.actions; // here methods to change state
export const todoSelector = state => state.todo.todos; // here data
