...
const Post = () => {
  ...
  const post = posts.find(p => p.postId === currPostId)
  ...
  return (
    <div className="App">
      <AppContext.Provider value={{
        posts: posts,
        postId: currPostId,
        onPostSelected: changeCurrentPost,
        addComment: addComment
      }}>{
            post ? <PostList author={post.author}
            date={post.date}
            title={post.title}
            content={post.content}
            comments={post.comments}
            onBackHandler={() => changeCurrentPost(null)}/> : <PostList/>
        }
      </AppContext.Provider>
    </div>
  )
